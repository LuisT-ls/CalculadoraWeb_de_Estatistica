  ...
  function setupCalculation() {
    ...
    switch (selectedOperation) {
      ...
      case 'lei-ohm-reversa':
        ...
        inputFields.innerHTML = '<input type="number" id="current" required>'
        inputFields.innerHTML += '<label for="voltage">Tensão (V):</label>'
        inputFields.innerHTML +=
      ...
      case 'potencia-eletrica':
        unitSelection.innerHTML = '<label for="voltage">Tensão (V):</label>'
        inputFields.innerHTML = '<input type="number" id="voltage" required>'
        inputFields.innerHTML += '<label for="current">Corrente (A):</label>'
        inputFields.innerHTML += '<input type="number" id="current" required>'
        break
      ...
      case 'lkt':
        ...
        inputFields.innerHTML = '<input type="number" id="voltage1" required>'
        inputFields.innerHTML += '<label for="voltage2">Tensão 2 (V):</label>'
        inputFields.innerHTML += '<input type="number" id="voltage2" required>'
        break
      case 'lkc':
        unitSelection.innerHTML =
          '<label for="current1">Corrente 1 (A):</label>'
        inputFields.innerHTML = '<input type="number" id="current1" required>'
        inputFields.innerHTML += '<label for="current2">Corrente 2 (A):</label>'
        inputFields.innerHTML += '<input type="number" id="current2" required>'
        break
      ...
      case 'lei-joule':
        ...
        inputFields.innerHTML += '<label for="time">Tempo (s):</label>'
        inputFields.innerHTML += '<input type="number" id="time" required>'
        break
      case 'constante-tempo-rc':
        unitSelection.innerHTML =
          '<label for="resistance">Resistência (Ω):</label>'
        inputFields.innerHTML = '<input type="number" id="resistance" required>'
        inputFields.innerHTML +=
      ...
      case 'calculo-corrente-curto-circuito':
        ...
        inputFields.innerHTML += '<input type="number" id="impedance" required>'
        break
      case 'calculo-queda-tensao-linhas-transmissao':
        ...
        inputFields.innerHTML +=
          '<label for="impedance">Impedância (Ω):</label>'
        inputFields.innerHTML += '<input type="number" id="impedance" required>'
        inputFields.innerHTML += '<label for="distance">Distância (m):</label>'
        inputFields.innerHTML += '<input type="number" id="distance" required>'
        break
      ...
      case 'calculo-fator-potencia':
        ...
        inputFields.innerHTML += '<input type="number" id="realPower" required>'
        break
      ...
      case 'calculo-tensao-toque-passo-linhas-aereas':
        ...
        inputFields.innerHTML += '<input type="number" id="spacing" required>'
        break
      ...
      case 'calculo-consumo-energia':
        ...
        inputFields.innerHTML = '<input type="number" id="power" required>'
        inputFields.innerHTML += '<label for="time">Tempo (h):</label>'
        inputFields.innerHTML += '<input type="number" id="time" required>'
        break
      case 'calculo-perda-energia-motores':
        unitSelection.innerHTML =
          '<label for="efficiency">Eficiência do Motor (%):</label>'
        inputFields.innerHTML = '<input type="number" id="efficiency" required>'
        inputFields.innerHTML +=
      ...
      case 'calculo-eficiencia-transformadores':
        ...
        inputFields.innerHTML = '<input type="number" id="inputPower" required>'
        inputFields.innerHTML +=
